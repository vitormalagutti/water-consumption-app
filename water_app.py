...
tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(["📂 1- Input Files Upload", "📊 2- Network Users Summary", "📅 3- Seasonal Water Demand Distribution", "💧 4- Water Demand Model", "💰 5- Billed Water Analysis", "🗺️ 6- Data Visualization"])
...
def plot_billed_vs_expected(df, n, selected_dmas_zones, start_date_dt, end_date_dt, title="Total Billed vs Expected EGP Values"):
    ...
    billed_columns = [col for col in df.columns[:n] if col.split(' ')[-1].strip() in selected_dmas_zones]
    ...
    if buildings_file:
        ...
        with tab5:
            ...
            if volume_file and value_file and correlation_file and buildings_file:
                ...
                billed_df = billed_df.drop_duplicates(subset='Block Number')
