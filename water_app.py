...
with tab1:
    ...
    if buildings_file:
        ...
        with tab5:
            ...
            # First condition: check if all necessary files are uploaded
            if volume_file and value_file and correlation_file and buildings_file:
                ...
                # Data preparation and merging logic here...

                # Second condition: check for visualization type
                if 'visualization_type' in locals():
                    
                    if visualization_type == "DMA" and "DMA" in available_options:
                        # DMA processing logic
                        ...
                        dma_merged_df = calculate_percentage_billed(dma_merged_df).drop(columns="Month")
                        # Display and plotting logic here...
                        ...
                        zone_merged_df = calculate_percentage_billed(zone_merged_df).drop(columns="Month")
                        # Display and plotting logic here...

            # If necessary files are not uploaded, display an error message
            else:
